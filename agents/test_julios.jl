...
try
    agent = JuliaOS.Agent(Dict("name" => "LifecycleTest"))
...
try
    agent = JuliaOS.Agent(Dict("name" => "CapabilityTest"))
    JuliaOS.start_agent(agent)
...
try
    agent = JuliaOS.Agent(Dict("name" => "ErrorTest"))
    JuliaOS.start_agent(agent)
...
try
    agent = JuliaOS.Agent(Dict("name" => "MetricsTest"))
    JuliaOS.start_agent(agent)
